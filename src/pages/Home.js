        ...
        {/* <ParentComponent /> */}
            <main className="grid grid-cols-2">
                <div className="text-white font-semibold  mt-36 ml-10 poppins-font"> 
                    <h1 className="text-7xl" > StarkPass: <span className="bg-gradient-to-r from-red-800 via-yellow-600 to-yellow-500 text-transparent bg-clip-text"> Crypto Passes, Your Way </span></h1>
                    <p className="text-lg  mt-8 mr-28">With StarkPass, you can book your Pass for Event using crypto and get your own Pass quickly. Embrace the future of ticketing -   it's fast, secure, and entirely hassle-free.</p>
                    <a href="/events">
